...
def EachBatchGroupOperation(MysqlObject):
    ...
    #print('done!/n/n')
    #print(GV.ReceiveStandardDataDict)
    if GV.ReceiveStandardDataDict:
        #print(GV.ReceiveStandardDataDict.keys())
        for SingleReceiveStandardDataListFileName in GV.ReceiveStandardDataDict:
            ...
            for ExtractTaskID in GV.ExtractPublicTaskInfoDict['ExtractTaskID']:
                #print(GV.ExtractPublicTaskInfoDict['ExtractTaskID'][ExtractTaskID]['filename'].strip('.txt'))
                #print(GV.ExtractPublicTaskInfoDict['ExtractTaskID'][ExtractTaskID]['filename'].strip('.txt'))
                #print(SingleReceiveStandardDataListFileName)
