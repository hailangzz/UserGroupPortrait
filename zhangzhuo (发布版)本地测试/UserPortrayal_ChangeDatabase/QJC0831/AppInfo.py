...
class App_data_path():
    def __init__(self):
        self.path = r'F:\UserGroupPortraitDataCheck\filenames\app_filename.txt'
        self.severse_path = r'F:\UserGroupPortraitData\app'
    ...
    def get_path(self):
        ...
        if len(self.new_path)==0:
            ...
            for name in self.new_path:
                ...
                data_path.append(r"F:\UserGroupPortraitData\app\%s" % (localfilename))
        return data_path
